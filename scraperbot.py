...
def main():
    ...
    with sync_playwright() as p:
        ...
        recentCourses = []
        with open("recentcourses.txt", "rt") as f:
            for i in f.readlines():
                recentCourses.append(i.strip())
        #print(recentCourses)
        
        if len(recentCourses) == len(courses):
            recentCourses = []
            with open("recentcourses.txt", "w") as f:
                f.write("") #reset
        
        for course in courses:
            if course in recentCourses:
                continue
            try:
                ...
                with open("recentcourses.txt", "a") as f:
                    f.writelines(f"\n{course}")
            except:
